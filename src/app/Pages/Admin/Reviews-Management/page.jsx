    ...
    <>
      ...
      <div className="admin-sidebar">
        ...
        <div className="admin-menu">
          ...
          <div className="admin-menu-item active" onClick={() => router.push("/Pages/Admin/Reviews-Management")}><Star size={18} /> Reviews & Ratings</div>
      ...
      <div className="admin-main">
        <div className="admin-header">
          <input className="admin-search" placeholder="Search reviews by customer, product..." />
